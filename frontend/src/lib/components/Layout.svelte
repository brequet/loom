...
<div class="min-h-screen bg-background text-foreground">
    <header class="border-b">
        <nav class="container mx-auto flex h-14 items-center gap-6 px-4">
            ...
            >
                <img src="/favicon.png" alt="Loom" class="h-8 w-8" />
                Loom
            </a>
            <div class="flex items-center gap-4 text-sm">
                <a
                    href="/"
                    use:link
                    class="transition-colors hover:text-foreground {isActive(
                        '/',
                    )
                        ? 'text-foreground font-medium'
                        : 'text-muted-foreground'}">Dashboard</a
                >
                <a
                    href="/settings"
                    use:link
                    class="transition-colors hover:text-foreground {isActive(
                        ...
                        ? 'text-foreground font-medium'
                        : 'text-muted-foreground'}">Settings</a
                >
            </div>
        </nav>
    </header>
